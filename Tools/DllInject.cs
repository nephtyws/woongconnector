...
namespace WoongConnector.Tools
{
    public static class Inject
    {
            ...
            out string sError)
        {
            ...
            sError = Marshal.GetLastWin32Error().ToString();
            ...
            out IntPtr hwnd)
        {
            ...
            if (hndProc == (IntPtr)0)
            {
                sError = "Unable to attach to process.\n";
        ...
        {
            var bRet = System.Text.Encoding.ASCII.GetBytes(sToConvert);
            return bRet;
        }
    }
}
